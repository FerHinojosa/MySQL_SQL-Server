...
common_words = {"del", "para", "como", "donde", "pero", "porque", "entonces", "sobre", "tiene", "todos", "muchos", "algunas", "siempre", "ahora"}
...
try:
    ...
    for (texto,) in cursor.fetchall():
        # Extraer palabras de más de 5 caracteres y que no estén en common_words
